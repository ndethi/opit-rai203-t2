...
It sets out on a path to democratize dataset creation for low-resourced languages and manages to do so by creating a well documented and replicable methodology, an actual NLP Model(JoeyMT) @joeyMT, and tangible community impact in the birthing of the Masakhane community @masakhane-io. The paper going by its citations counts has indeed contributed fundamentally to the field of LRL and in that it has achived its purpose.
...
-   Association for Computational Linguistics. (n.d.). *ACL Anthology*. Retrieved from https://www.aclweb.org/anthology/
-   Empirical Methods in Natural Language Processing. (n.d.). *EMNLP*. Retrieved from https://2025.emnlp.org/
