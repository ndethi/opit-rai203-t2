...
As the term edge suggests, this paradigm involves placing cloud resources in close proximity to where data to be stored in the cloud instance is generated, where end users are located. The main motivation for this arrangement being reducted data latency and increased availability of resources.

## LifeX and EdgeX Use Cases
