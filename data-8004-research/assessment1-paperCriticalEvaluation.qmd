...
## Introduction
My interest in the paper "Participatory Research for Low-resourced Machine Translation" by Abbott and Martinus (2020) stems from a curiosity about how Machine Translation could be used to promote uptake of Kikuyu, my mothertongue, while leveraging collaborative creation of annotatable datasets from the older generation.
